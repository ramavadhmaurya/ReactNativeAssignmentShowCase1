...
export default class DeviceRegistrationFailure extends Component {

    failureMessage() {
        return "Simpli-Fi Registration Failure"
    }
        ...
        return (
            ...
            <View style={{ flex: 1, justifyContent:'center', backgroundColor: Constants.ThemeColors.appBGColor }}>
                <View style={{ height: 40 }}>
                    <Text style={{height: 30, opacity:0.44, alignSelf: "center", fontSize:16, fontFamily:Constants.Fonts.themeFontRegular, color: "black", marginTop: 10 }}>{translator.t("simplifiRegistration")}</Text>
                </View>
                <Image
